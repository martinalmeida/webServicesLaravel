...
@section('title')
    VolApp - Informes Movimientos
@endsection

@section('head')
    <x-header title="Informes a Proveedores por Movimientos">
    ...
    <x-panel title="Informes a Proveedor por Alquiler" subTitle="modulo de generación de informes.">
        <div class="panel-content">
            ...
            <button type="button" id="btnGenerar"
                ...
                Proveedor por Movimiento <i class="fal fa-file-download"></i></button>
        </div>
...
@section('subName')
    Pagina de Informes por Movimientos
@endsection
        ...
        function cargarTablaInforme() {
            ...
            if (placa == null || fechaInicio == 0 || fechaFin == 0) {
                ...
                html =
                    ...
                    "<th>Ruta (Origen - Destino)</th><th>Kilometros</th><th>Tarifa por kilometro</th><th>Metros Cubicos</th><th>Peaje</th>" +
                    "<th>Movimientos</th><th>Dedicible Administración</th><th>Dedicible Retefuente</th><th>Dedicible Reteica</th>" +
                    "<th>Dedicible Anticipo</th><th>Otros Dedicibles</th><th>Total</th><th>Observación</th>" +
                ...
                tablaInformes = $('#tablaInformes').DataTable({
                    ...
                    destroy: true,
                    ajax: {
                        url: "{{ route('table.informeMovimiento') }}",
                        type: "POST",
                        data: {
                            placa: placa,
